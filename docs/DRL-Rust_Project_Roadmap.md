...
## 3. Current Progress Summary (`VERSION` 0.2.95)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.95`)**: Ranged-command target
  ...
  use, missing-item use, and no-weapon/full-clip/no-ammo reload rejections are
