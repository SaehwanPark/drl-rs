...
## 3. Current Progress Summary (`VERSION` 0.2.97)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.97`)**: Ranged-command target
  ...
  descend, blocked-terrain movement, and out-of-bounds movement rejections are
  covered by exact `Game` equality tests. Other command-family rejection paths
  remain active Gate A follow-up work.
