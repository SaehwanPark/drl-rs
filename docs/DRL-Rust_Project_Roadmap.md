...
## 3. Current Progress Summary (`VERSION` 0.2.99)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.99`)**: Ranged-command target
  ...
  melee, empty-target melee, missing-item Equip/Drop, and no-ground-item Pickup
