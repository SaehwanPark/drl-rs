...
## 3. Current Progress Summary (`VERSION` 0.2.96)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.96`)**: Ranged-command target
  ...
  descend rejections are covered by exact `Game` equality tests. Other
