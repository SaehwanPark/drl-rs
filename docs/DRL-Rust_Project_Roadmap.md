...
Current project version: `0.2.100`
...
## 3. Current Progress Summary (`VERSION` 0.2.100)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.100`)**: Ranged-command target
  ...
  out-of-bounds ranged, and empty-target ranged rejections are covered by exact
  `Game` equality tests. Other command-family rejection paths remain active Gate
  A follow-up work.
