...
## 3. Current Progress Summary (`VERSION` 0.2.101)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.101`)**: Ranged-command target
  ...
  ranged rejections are covered by exact `Game` equality tests. Other
