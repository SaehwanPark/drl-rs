...
## 3. Current Progress Summary (`VERSION` 0.2.105)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.105`)**: Ranged-command target
  ...
  vectors; replay semantics versioning remains open.
