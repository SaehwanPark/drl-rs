...
## 3. Current Progress Summary (`VERSION` 0.2.94)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.94`)**: Ranged-command target
  ...
  use, and missing-item use rejections are covered by exact `Game` equality
