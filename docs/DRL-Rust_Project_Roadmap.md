...
## 3. Current Progress Summary (`VERSION` 0.2.98)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.98`)**: Ranged-command target
  ...
  melee, and empty-target melee rejections are covered by exact `Game` equality
  tests. Other command-family rejection paths remain active Gate A follow-up
  work.
