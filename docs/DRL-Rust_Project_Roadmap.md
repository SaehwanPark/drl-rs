...
## 3. Current Progress Summary (`VERSION` 0.2.91)
...
- **M1/M2 Correctness Slice (`0.2.89`–`0.2.91`)**: Ranged-command target
  ...
  changes. Out-of-range, blocked-line, non-equippable-item, and full-backpack
  pickup rejections are covered by exact `Game` equality tests. Other
  command-family rejection paths remain active Gate A follow-up work.
