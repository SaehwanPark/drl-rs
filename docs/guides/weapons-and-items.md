...
- **Revenant's Launcher**: Unique single-rocket launcher with an exact-hit policy and typed direct Fire damage (so Red Armor's 25% Fire resistance applies before flat protection) and single-rocket tactical reload.
...
| **Red Armor** | 4 flat protection; 25% Fire resistance on typed Rocket direct/splash, Anti-Freak direct/splash, Missile Launcher direct hits, and Revenant's Launcher direct hits | High-grade armor that reduces typed Fire damage before flat protection. Broader resistance aggregation remains open. |
