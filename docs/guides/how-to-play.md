...
| **First-Level Chainfire** | `C` | — | Fire the available BFG 10K/Chaingun/Minigun/Plasma Rifle/Laser Rifle/Nuclear Plasma burst (4 BFG 10K projectiles at 20 cells; 3 or 6 rotary projectiles; 4 energy projectiles) |
