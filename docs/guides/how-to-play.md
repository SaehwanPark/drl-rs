...
| **Chainfire** | `C` | — | Fire the currently available BFG 10K/Chaingun/Minigun/Plasma Rifle/Laser Rifle/Nuclear Plasma burst; warm-up levels select each weapon's typed projectile/cell profile |
