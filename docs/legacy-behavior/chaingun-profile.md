...
eleventh-, and twelfth-level chainfire for `0.2.316`;
thirteenth-and-later chainfire levels,
...
- `src/dfbeing.pas:1477-1491` resolves ordinary fire to four projectiles,
  ...
  (`4 + (4 div 2)`); this slice bounds the twelfth level while leaving later
...
second-, third-, fourth-, fifth-, sixth-, seventh-, eighth-, ninth-, tenth-,
eleventh-, and twelfth-level chainfire fragments. The existing
...
rounds at level one, and six rounds at levels two through eleven atomically, emits
...
Thirteenth-and-later chainfire levels, legacy target rotation/spread, exact
