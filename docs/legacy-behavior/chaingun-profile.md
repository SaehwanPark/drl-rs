...
second-, third-, fourth-, and fifth-level chainfire for `0.2.309`; sixth-and-later
chainfire levels,
...
- `src/dfbeing.pas:1477-1491` resolves ordinary fire to four projectiles,
  ...
  (`4 + (4 div 2)`); this slice bounds the fifth level while leaving later
...
second-, third-, fourth-, and fifth-level chainfire fragments. The existing ranged
...
rounds at level one, and six rounds at levels two through four atomically, emits the
...
Sixth-and-later chainfire levels, legacy target rotation/spread, exact
