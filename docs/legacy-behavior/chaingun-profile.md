...
second-, third-, fourth-, fifth-, and sixth-level chainfire for `0.2.310`;
...
- `src/dfbeing.pas:1477-1491` resolves ordinary fire to four projectiles,
  ...
  (`4 + (4 div 2)`); this slice bounds the sixth level while leaving later
...
second-, third-, fourth-, fifth-, and sixth-level chainfire fragments. The existing
...
rounds at level one, and six rounds at levels two through five atomically, emits
...
Seventh-and-later chainfire levels, legacy target rotation/spread, exact
