...
commands remain atomic. The `0.2.264` first-level chainfire slice and the
  bounded `0.2.305` twenty-first-level extension reuse that exact-hit policy for four,
  five, and nineteen seven-projectile ordered bursts. Scatter, twenty-second-and-later
chainfire levels,
