...
bounded `0.2.301` seventeenth-level extension reuse that exact-hit policy for four,
five, and fifteen seven-projectile ordered bursts. Scatter, eighteenth-and-later
chainfire levels,
