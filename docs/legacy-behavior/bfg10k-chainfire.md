...
- `src/dfbeing.pas:1486-1493` applies the chainfire adjustment by warm-up
  ...
  BFG 10K's five configured shots, the first fourteen bounded levels therefore
  emit four, five, seven, seven, seven, seven, seven, seven, seven, seven, seven, seven, seven, and seven projectiles;
...
Gameplay semantics `107` (project version `0.2.298`) extends the typed BFG 10K
chainfire command with the pinned fourteenth warm-up level. At level zero, a valid
...
levels two through thirteen accept a valid visible target and at least thirty-five
...
metadata, and advance warm-up through levels three through fourteen. Post-lethal
slots remain deterministic no-op misses, ordinary fire resets the warm-up
state, and fifteenth-level and later requests remain atomic rejections.
Direct-core, reload-backed replay, ScenarioRunner, MCP legal-action/JSON,
physical browser key, and BrowserSession parity plus atomic fourteenth-level and under-supply
rejection are covered. Fifteenth and later levels, scatter/target rotation,
