...
- `src/dfbeing.pas:1486-1493` applies the chainfire adjustment by warm-up
  ...
  BFG 10K's five configured shots, the first fifteen bounded levels therefore
  emit four, five, seven, seven, seven, seven, seven, seven, seven, seven, seven, seven, seven, seven, and seven projectiles;
...
Gameplay semantics `108` (project version `0.2.299`) extends the typed BFG 10K
chainfire command with the pinned fifteenth warm-up level. At level zero, a valid
...
levels two through fourteen accept a valid visible target and at least thirty-five
...
metadata, and advance warm-up through levels three through fifteen. Post-lethal
slots remain deterministic no-op misses, ordinary fire resets the warm-up
state, and sixteenth-level and later requests remain atomic rejections.
Direct-core, reload-backed replay, ScenarioRunner, MCP legal-action/JSON,
physical browser key, and BrowserSession parity plus atomic fifteenth-level and under-supply
rejection are covered. Sixteenth and later levels, scatter/target rotation,
