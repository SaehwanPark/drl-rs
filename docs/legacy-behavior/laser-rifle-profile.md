...
third-, fourth-, and fifth-level chainfire execution in `0.2.287`; higher
chainfire levels,
...
two through four). The existing ranged command path remains execution authority
...
reset/advancement through level five, and deterministic replay.
