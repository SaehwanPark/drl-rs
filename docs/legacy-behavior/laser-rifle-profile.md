...
third-, fourth-, fifth-, and sixth-level chainfire execution in `0.2.288`;
higher chainfire levels,
...
two through five). The existing ranged command path remains execution authority
...
reset/advancement through level six, and deterministic replay.
