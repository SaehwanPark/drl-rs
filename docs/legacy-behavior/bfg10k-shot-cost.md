...
the existing five-projectile direct-target path and bounded first- through
  twenty-first-level chainfire paths. A valid visible, in-range BFG 10K volley with a
full clip consumes twenty-five cells; the first two chainfire levels consume
  twenty and twenty-five cells, followed by nineteen seven-projectile levels that
