...
pub enum GameEvent {
  ...
  /// Revenant's Launcher recorded its evidence-backed Fire explosion payload.
  RevenantsLauncherExplosionScheduled {
    entity_id: EntityId,
    target_id: EntityId,
    delay: u32,
    radius: u32,
  ...
  /// Missile Launcher recorded its evidence-backed delayed explosion payload.
  MissileLauncherExplosionScheduled {
    entity_id: EntityId,
    target_id: EntityId,
    delay: u32,
    radius: u32,
  ...
  /// Standard BFG 9000 recorded its evidence-backed delayed explosion payload.
  Bfg9000ExplosionScheduled {
    entity_id: EntityId,
    target_id: EntityId,
    delay: u32,
    radius: u32,
