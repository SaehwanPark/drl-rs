...
pub use types::{
  ...
  ItemId, LevelId, MegaBusterMorphMode, MonsterDefinition, MonsterKind, Position, Speed, Target,
  Turn,
};
...
mod tests {
  ...
  #[test]
  fn fixed_content_identity_is_exported_for_bound_snapshots() {
    assert_eq!(CURRENT_FIXED_CONTENT_ID, "fixed-m4-v1");
  }
}
