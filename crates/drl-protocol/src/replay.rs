...
/// when other deterministic simulation rules change. Version `106` includes
/// BFG 10K's typed thirteenth-level seven-projectile chainfire burst; version `105`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 106;
