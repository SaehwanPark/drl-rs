...
/// when other deterministic simulation rules change. Version `104` includes
/// BFG 10K's typed eleventh-level seven-projectile chainfire burst; version `103`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 104;
