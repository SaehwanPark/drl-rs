...
/// when other deterministic simulation rules change. Version `105` includes
/// BFG 10K's typed twelfth-level seven-projectile chainfire burst; version `104`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 105;
