...
/// when other deterministic simulation rules change. Version `101` includes
/// BFG 10K's typed eighth-level seven-projectile chainfire burst; version `100`
/// includes BFG 10K's typed seventh-level seven-projectile chainfire burst;
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 101;
