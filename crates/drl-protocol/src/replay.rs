...
/// when other deterministic simulation rules change. Version `19` includes
/// the typed Combat Shotgun pump-action chamber policy.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 19;
...
pub struct ReplayMetadata {
  ...
  /// Version 19 includes the typed Combat Shotgun pump-action chamber policy.
