...
/// when other deterministic simulation rules change. Version `18` includes
/// the typed Combat Shotgun single-shell reload policy.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 18;
...
pub struct ReplayMetadata {
  ...
  /// Version 18 includes the typed Combat Shotgun single-shell reload policy.
