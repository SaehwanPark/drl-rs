...
/// when other deterministic simulation rules change. Version `74` includes
/// BFG 10K's typed radius-2 actor splash; version `73` includes its typed
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 74;
...
pub struct ReplayMetadata {
  ...
  /// Version 74 includes BFG 10K's typed radius-2 actor splash; version 73
  /// includes its typed first-level four-projectile chainfire burst; version 72
  /// includes Nuclear Plasma Rifle's typed first-level four-projectile
