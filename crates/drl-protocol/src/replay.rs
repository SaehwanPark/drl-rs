...
/// when other deterministic simulation rules change. Version `64` includes
/// Anti-Freak Jackal's typed ground-item destruction, version `63`'s typed
/// splash knockback, version `62`'s typed radius-1 splash fanout, version
/// `61`'s typed delayed-explosion schedule, version `60`'s typed
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 64;
...
pub struct ReplayMetadata {
  ...
  /// Version 64 includes Anti-Freak Jackal's typed ground-item destruction,
  /// version 63 includes its typed splash knockback, version 62 includes its
  /// typed radius-1 splash fanout, version 61 includes its typed
