...
/// when other deterministic simulation rules change. Version `103` includes
/// BFG 10K's typed tenth-level seven-projectile chainfire burst; version `102`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 103;
