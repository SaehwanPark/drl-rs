...
/// when other deterministic simulation rules change. Version `126` includes
/// Chaingun's typed thirteenth-level six-projectile chainfire burst; version `125`
/// includes Chaingun's typed twelfth-level six-projectile chainfire burst;
...
/// Laser Rifle.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 126;
...
pub struct ReplayMetadata {
  ...
  /// Version 126 includes Chaingun's typed thirteenth-level six-projectile
  /// chainfire burst; version 125 includes Chaingun's typed twelfth-level
