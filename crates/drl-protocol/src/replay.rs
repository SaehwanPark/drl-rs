...
/// when other deterministic simulation rules change. Version `108` includes
/// BFG 10K's typed fifteenth-level seven-projectile chainfire burst; version `107`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 108;
