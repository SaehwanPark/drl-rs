...
/// when other deterministic simulation rules change. Version `139` includes
/// Plasma Rifle's typed Plasma classification on direct target damage; version
/// `138` includes BFG 10K's typed Plasma classification on direct volley target
/// damage;
...
/// Laser Rifle.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 139;
...
pub struct ReplayMetadata {
  ...
  /// on direct volley target damage; version 137 includes Nuclear BFG 9000's typed
