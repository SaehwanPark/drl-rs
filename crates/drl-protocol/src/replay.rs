...
/// when other deterministic simulation rules change. Version `110` includes
/// BFG 10K's typed seventeenth-level seven-projectile chainfire burst; version `109`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 110;
