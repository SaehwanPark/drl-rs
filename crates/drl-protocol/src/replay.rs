...
/// when other deterministic simulation rules change. Version `109` includes
/// BFG 10K's typed sixteenth-level seven-projectile chainfire burst; version `108`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 109;
