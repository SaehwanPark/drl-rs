...
/// when other deterministic simulation rules change. Version `32` includes
/// Nuclear BFG 9000 exact-hit resolution in addition to standard BFG exact-hit,
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 32;
...
pub struct ReplayMetadata {
  ...
  /// Version 32 includes Nuclear BFG 9000 exact-hit resolution in addition to
  /// standard BFG exact-hit, typed Nuclear BFG 9000 alternate overload, Nuclear Plasma alternate overload,
