...
/// when other deterministic simulation rules change. Version `107` includes
/// BFG 10K's typed fourteenth-level seven-projectile chainfire burst; version `106`
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 107;
