...
/// when other deterministic simulation rules change. Version `93` includes
/// Nuclear Plasma Rifle's typed fourth-level nine-projectile chainfire burst;
/// version `92` includes BFG 10K's typed fourth-level seven-projectile chainfire
/// burst; version `91` includes Laser Rifle's typed fourth-level
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 93;
...
pub struct ReplayMetadata {
  ...
  /// Version 93 includes Nuclear Plasma Rifle's typed fourth-level
  /// nine-projectile chainfire burst; version 92 includes BFG 10K's typed
  /// fourth-level seven-projectile chainfire burst; version 91 includes Laser
  /// Rifle's typed fourth-level seven-projectile chainfire burst; version 90
