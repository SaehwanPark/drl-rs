...
/// when other deterministic simulation rules change. Version `125` includes
/// Chaingun's typed twelfth-level six-projectile chainfire burst; version `124`
/// includes Chaingun's typed eleventh-level six-projectile chainfire burst;
...
/// Laser Rifle.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 125;
...
pub struct ReplayMetadata {
  ...
  /// Version 125 includes Chaingun's typed twelfth-level six-projectile
  /// chainfire burst; version 124 includes Chaingun's typed eleventh-level
