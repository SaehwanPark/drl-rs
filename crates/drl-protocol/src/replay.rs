...
/// when other deterministic simulation rules change. Version `63` includes
/// Anti-Freak Jackal's typed splash knockback, version `62`'s typed radius-1
/// splash fanout, version `61`'s typed delayed-explosion schedule, version
/// `60`'s typed
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 63;
...
pub struct ReplayMetadata {
  ...
  /// Version 63 includes Anti-Freak Jackal's typed splash knockback, version
  /// 62 includes its typed radius-1 splash fanout, version 61 includes its
  /// typed delayed-explosion schedule, version 60
