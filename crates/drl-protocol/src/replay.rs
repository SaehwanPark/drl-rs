...
/// when other deterministic simulation rules change. Version `148` includes
...
/// armor-protection divisor; version `143` includes Anti-Freak Jackal's
/// typed Fire classification on direct target damage; version `142` includes
/// Blaster's typed Plasma classification on direct target
...
/// classification on direct target damage; version `138` includes BFG 10K's
/// typed Plasma classification on direct volley target damage;
...
/// Launcher's thresholded ordinary ground-item destruction; version `133`
/// includes Null Pointer's typed Plasma mitigation
...
/// `130` includes Blue Armor's typed Plasma mitigation on actor splash; version `129` includes
...
/// Laser Rifle.
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 148;
...
pub struct ReplayMetadata {
  ...
  /// Version 148 includes Revenant's Launcher's typed Fire classification on
  /// direct target damage; version 147 includes Missile Launcher's typed
  /// Fire classification on direct target damage; version 146 includes
  ...
  /// classification on direct target damage; version 140
  ...
  /// classification on direct target damage; version 138 includes BFG 10K's
  /// typed Plasma classification on direct volley target damage; version 137
  /// includes Nuclear BFG 9000's typed Plasma classification on direct target
  /// damage; version 136 includes Standard BFG 9000's typed Plasma
  /// classification on direct target damage; version 135 includes Rocket
  /// Launcher's typed Fire classification on direct target damage;
  /// version 134 includes Rocket Launcher's thresholded ground-item
  /// destruction after post-falloff damage;
  ...
  /// on actor splash; version 129 includes the bounded Rocket Launcher radius-4 actor
