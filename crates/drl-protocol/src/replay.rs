...
/// when other deterministic simulation rules change. Version `94` includes
/// Nuclear Plasma Rifle's typed fifth-level nine-projectile chainfire burst;
...
pub const CURRENT_GAMEPLAY_SEMANTICS_VERSION: u32 = 94;
