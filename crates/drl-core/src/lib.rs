...
pub use behavior::{
  ...
  COMBAT_SHOTGUN_BEHAVIOR, DOUBLE_SHOTGUN_BEHAVIOR, EquipEffect, GRAMMATON_BEHAVIOR, HitEffect,
  ItemSetId, JACKHAMMER_BEHAVIOR, KillEffect, LAVA_ARMOR_BEHAVIOR, MALEK_ARMOR_BEHAVIOR,
