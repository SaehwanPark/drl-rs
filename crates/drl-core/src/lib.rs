...
pub use behavior::{
  ACID_SPITTER_BEHAVIOR, ASSAULT_SHOTGUN_BEHAVIOR, AlternateAction, AttackEffect, BFG10K_BEHAVIOR,
  BFG9000_BEHAVIOR, BLASTER_BEHAVIOR, BLASTER_RECHARGE_AMOUNT, BLASTER_RECHARGE_DELAY,
  BLASTER_RECHARGE_TICK, BehaviorProfile, BehaviorSpec, COMBAT_SHOTGUN_BEHAVIOR, EquipEffect,
  GRAMMATON_BEHAVIOR, HitEffect, ItemSetId, JACKHAMMER_BEHAVIOR, KillEffect, LAVA_ARMOR_BEHAVIOR,
  MALEK_ARMOR_BEHAVIOR, MEDICAL_POWERARMOR_BEHAVIOR, MEDICAL_REPAIR_INTERVAL,
  MEDICAL_REPAIR_MIN_DURABILITY_EXCLUSIVE, MEDICAL_REPAIR_TIMER_AFTER_REPAIR,
  ...
  NUCLEAR_PLASMA_RECHARGE_TICK, NULL_POINTER_BEHAVIOR, PassiveModifier, PassiveStat,
  PeriodicEffect, REVENANTS_LAUNCHER_BEHAVIOR, ResourceCost, SUBTLE_KNIFE_BEHAVIOR, StatusCost,
