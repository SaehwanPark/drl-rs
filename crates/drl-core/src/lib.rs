...
pub use behavior::{
  ...
  KillEffect, LASER_RIFLE_BEHAVIOR, LASER_RIFLE_PROJECTILE_COUNT, LAVA_ARMOR_BEHAVIOR,
  ...
  PISTOL_PROJECTILE_COUNT, PLASMA_RIFLE_BEHAVIOR, PLASMA_RIFLE_PROJECTILE_COUNT,
  PLASMA_RIFLE_SHOT_COST, PLASMA_SHOTGUN_BEHAVIOR, PLASMA_SHOTGUN_PROJECTILE_COUNT,
  ...
  SHOTGUN_KNOCKBACK_DISTANCE, SUBTLE_KNIFE_BEHAVIOR, SUPER_SHOTGUN_BEHAVIOR,
  SUPER_SHOTGUN_PROJECTILE_COUNT, StatusCost, StatusEffect, TRIGUN_BEHAVIOR,
  TRIGUN_PROJECTILE_COUNT, TRIGUN_SHOT_COST, TRISTAR_BLASTER_BEHAVIOR,
