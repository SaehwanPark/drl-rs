...
pub use behavior::{
  ...
  BFG10K_EXPLOSION_RADIUS, BFG10K_PROJECTILE_COUNT, BFG10K_SHOT_COST, BFG9000_BEHAVIOR,
  ...
  CHAINGUN_PROJECTILE_COUNT, COMBAT_PISTOL_BEHAVIOR, COMBAT_PISTOL_PROJECTILE_COUNT,
