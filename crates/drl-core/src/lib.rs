...
pub use behavior::{
  ACID_SPITTER_BEHAVIOR, ASSAULT_SHOTGUN_BEHAVIOR, ActionEffect, AlternateAction, AttackEffect,
  BFG10K_BEHAVIOR, BFG9000_BEHAVIOR, BLASTER_BEHAVIOR, BLASTER_RECHARGE_AMOUNT,
  BLASTER_RECHARGE_DELAY, BLASTER_RECHARGE_TICK, BehaviorProfile, BehaviorSpec,
  ...
  KillEffect, LAVA_ARMOR_BEHAVIOR, MALEK_ARMOR_BEHAVIOR, MEDICAL_POWERARMOR_BEHAVIOR,
  ...
  NULL_POINTER_BEHAVIOR, PISTOL_BEHAVIOR, PISTOL_PROJECTILE_COUNT, PLASMA_SHOTGUN_BEHAVIOR,
  ...
  ResourceCost, SHOTGUN_BEHAVIOR, SHOTGUN_KNOCKBACK_DISTANCE, SUBTLE_KNIFE_BEHAVIOR, StatusCost,
