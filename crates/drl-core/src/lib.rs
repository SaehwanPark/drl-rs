...
pub use behavior::{
  ...
  LASER_RIFLE_CHAINFIRE_SHOT_COST, LASER_RIFLE_PROJECTILE_COUNT, LAVA_ARMOR_BEHAVIOR,
  MALEK_ARMOR_BEHAVIOR, MEDICAL_POWERARMOR_BEHAVIOR, MEDICAL_REPAIR_INTERVAL,
