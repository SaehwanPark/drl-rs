...
pub use behavior::{
  ...
  BFG10K_SECOND_CHAINFIRE_SHOT_COST, BFG10K_SHOT_COST, BFG9000_BEHAVIOR, BLASTER_BEHAVIOR,
  BLASTER_PROJECTILE_COUNT, BLASTER_RECHARGE_AMOUNT, BLASTER_RECHARGE_DELAY, BLASTER_RECHARGE_TICK,
  BLASTER_SHOT_COST, BehaviorProfile, BehaviorSpec, CHAINGUN_BEHAVIOR, CHAINGUN_PROJECTILE_COUNT,
