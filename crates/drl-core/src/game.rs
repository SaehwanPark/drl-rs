...
impl Game {
  ...
  fn execute_player_reload(
    ...
    let (ammo_type, needed, reload_cost) = {
      ...
      // The legacy Assault/Combat Shotgun and Missile Launcher definitions carry
  ...
  fn execute_player_ranged_attack(
    ...
    let (
      ...
      let weapon_is_revenants_launcher =
        weapon.archetype() == drl_protocol::ItemArchetype::RevenantsLauncher;
      (
        props.fire_cost,
        shot_count,
        ammo_cost,
      ...
      || weapon_is_revenants_launcher
    {
      ...
      for splash_position in splash_positions {
        if self
          .state
          .world
    ...
    if weapon_is_railgun {
      ...
      for _ in 0..shot_count {
        ...
        if weapon_is_missile_launcher {
          ...
          self.execute_bfg10k_splash(player_id, target_pos, events)?;
        } else if weapon_is_bfg9000 {
