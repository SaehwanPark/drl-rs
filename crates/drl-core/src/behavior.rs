...
/// five-projectile volley, and levels two and three add half the configured
...
/// full six-projectile volley at level one, and nine projectiles at level two;
/// higher levels remain deferred.
#[must_use]
...
mod tests {
  ...
  fn bfg10k_chainfire_profile_matches_pinned_warmup_levels() {
    ...
    assert_eq!(bfg10k_chainfire_profile(4), None);
  }
  ...
  fn nuclear_plasma_chainfire_profile_matches_pinned_warmup_levels() {
    ...
    assert_eq!(nuclear_plasma_chainfire_profile(3), None);
  }
