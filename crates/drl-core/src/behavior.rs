...
/// five-projectile volley, and levels two through eleven add half the configured
/// shot count for seven projectiles. Fourteenth and later levels remain outside
/// this slice.
#[must_use]
...
mod tests {
  ...
  fn bfg10k_chainfire_profile_matches_pinned_warmup_levels() {
    ...
    assert_eq!(bfg10k_chainfire_profile(13), None);
  }
