...
#[test]
fn bfg10k_fourth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kFourthChainfireVertical",
    "BFG 10K carries its four-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_sixth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kSixthChainfireVertical",
    "BFG 10K carries its sixth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  scenario.player_config = Some(PlayerSpawnConfig {
    ...
    max_hp: 50,
    speed: 100,
    initial_items: vec![ItemSpawnKind::AmmoCells(200)],
    equipped_weapon: Some(ItemSpawnKind::Bfg10k),
    equipped_armor: None,
    equipped_armor_durability: None,
  });
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 6);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_seventh_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kSeventhChainfireVertical",
    "BFG 10K carries its seventh-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_eighth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kEighthChainfireVertical",
    "BFG 10K carries its eighth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_ninth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kNinthChainfireVertical",
    "BFG 10K carries its ninth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_tenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kTenthChainfireVertical",
    "BFG 10K carries its tenth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_eleventh_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kEleventhChainfireVertical",
    "BFG 10K carries its eleventh-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_twelfth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kTwelfthChainfireVertical",
    "BFG 10K carries its twelfth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn bfg10k_thirteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kThirteenthChainfireVertical",
    "BFG 10K carries its thirteenth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 13);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_fourteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kFourteenthChainfireVertical",
    "BFG 10K carries its fourteenth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 14);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_eighteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kEighteenthChainfireVertical",
    "BFG 10K carries its eighteenth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 18);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_nineteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kNineteenthChainfireVertical",
    "BFG 10K carries its nineteenth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 19);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_twentieth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kTwentiethChainfireVertical",
    "BFG 10K carries its twentieth-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  scenario.player_config = Some(PlayerSpawnConfig {
    ...
    max_hp: 50,
    speed: 100,
    initial_items: vec![ItemSpawnKind::AmmoCells(675)],
    equipped_weapon: Some(ItemSpawnKind::Bfg10k),
    equipped_armor: None,
    equipped_armor_durability: None,
  });
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 20);
  assert_eq!(replay.commands, commands);
...
#[test]
fn bfg10k_twenty_first_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "Bfg10kTwentyFirstChainfireVertical",
    "BFG 10K carries its twenty-first-stage chainfire encounter across reloads",
    "########\n#@....h#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 15);
  assert_eq!(properties.chainfire_level, 21);
  assert_eq!(replay.commands, commands);
...
#[test]
fn chaingun_fourth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunFourthChainfireVertical",
    "Chaingun carries its fourth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let weapon = game.world().player().unwrap().equipment().weapon().unwrap();
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 21);
  assert_eq!(properties.chainfire_level, 4);
  assert_eq!(replay.commands, commands);
...
#[test]
fn chaingun_fifth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunFifthChainfireVertical",
    "Chaingun carries its fifth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_sixth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunSixthChainfireVertical",
    "Chaingun carries its sixth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let weapon = game.world().player().unwrap().equipment().weapon().unwrap();
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 9);
  assert_eq!(properties.chainfire_level, 6);
  assert_eq!(replay.commands, commands);
...
#[test]
fn chaingun_seventh_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunSeventhChainfireVertical",
    "Chaingun carries its seventh-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_eighth_chainfire_vertical_scenario_preserves_reload_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunEighthChainfireVertical",
    "Chaingun reloads before its eighth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_ninth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunNinthChainfireVertical",
    "Chaingun carries its ninth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_tenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunTenthChainfireVertical",
    "Chaingun carries its tenth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_eleventh_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunEleventhChainfireVertical",
    "Chaingun carries its eleventh-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_twelfth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunTwelfthChainfireVertical",
    "Chaingun carries its twelfth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn chaingun_thirteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunThirteenthChainfireVertical",
    "Chaingun carries its thirteenth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
  ...
  let weapon = game.world().player().unwrap().equipment().weapon().unwrap();
  let properties = weapon.weapon_properties().unwrap();
  assert_eq!(properties.current_clip, 4);
  assert_eq!(properties.chainfire_level, 13);
  assert_eq!(replay.commands, commands);
...
#[test]
fn chaingun_fourteenth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "ChaingunFourteenthChainfireVertical",
    "Chaingun carries its fourteenth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn laser_rifle_fifth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "LaserRifleFifthChainfireVertical",
    "Laser Rifle carries its fifth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn laser_rifle_sixth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "LaserRifleSixthChainfireVertical",
    "Laser Rifle carries its sixth-stage chainfire encounter",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn laser_rifle_seventh_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "LaserRifleSeventhChainfireVertical",
    "Laser Rifle carries its seventh-stage chainfire encounter across a reload",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn nuclear_bfg_shot_cost_vertical_scenario_preserves_clip_and_replay() {
  let mut scenario = Scenario::from_ascii(
    "NuclearBfgShotCostVertical",
    "Nuclear BFG 9000 consumes forty cells in the canonical one-shot path",
    "########\n#@...h.#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 0;
...
#[test]
fn nuclear_plasma_fourth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "NuclearPlasmaFourthChainfireVertical",
    "Nuclear Plasma Rifle reaches its fourth chainfire level after recharge",
    "########\n#@..h..#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 2_652;
  ...
  let mut commands = Vec::with_capacity(51);
  commands.extend([
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
...
#[test]
fn nuclear_plasma_fifth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "NuclearPlasmaFifthChainfireVertical",
    "Nuclear Plasma Rifle reaches its fifth chainfire level after recharge",
    "########\n#@..h..#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 2_656;
  ...
  let target = Position::new(4, 1);
  let mut commands = Vec::with_capacity(109);
  commands.extend([
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
...
#[test]
fn nuclear_plasma_sixth_chainfire_vertical_scenario_preserves_replay() {
  let mut scenario = Scenario::from_ascii(
    "NuclearPlasmaSixthChainfireVertical",
    "Nuclear Plasma Rifle reaches its sixth chainfire level after recharge",
    "########\n#@..h..#\n#......#\n########\n",
  )
  .unwrap();
  scenario.seed = 2_659;
  ...
  let target = Position::new(4, 1);
  let mut commands = Vec::with_capacity(166);
  commands.extend([
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
    Command::AttackRangedChainfire(target),
