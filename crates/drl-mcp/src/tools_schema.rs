...
/// Schema for transactional canonical V2 replay restoration.
#[must_use]
...
pub fn game_step_action_schema() -> JsonValue {
  let JsonValue::Object(mut schema) = create_object_schema(&[
    ...
    SchemaField::new(
      "target_x",
      "integer",
      "Target X coordinate (for fire, aimed_fire, or chainfire)",
      false,
    )
    ...
    SchemaField::new(
      "target_y",
      "integer",
      "Target Y coordinate (for fire, aimed_fire, or chainfire)",
      false,
    )
    .with_range(I32_MIN, I32_MAX),
