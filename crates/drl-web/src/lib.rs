...
mod tests {
  ...
  fn snapshot_round_trip_replays_fixed_session_deterministically() {
    ...
    assert_eq!(
      token,
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:4:mr;mr;mr;p"
    );
  ...
  fn v3_snapshot_round_trips_empty_history() {
    ...
    assert_eq!(
      token,
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:0:"
    );
  ...
  fn snapshot_rejects_corruption_and_unknown_versions() {
    let mut session = BrowserSession::new().expect("fixed session");
    assert_eq!(
      session.restore_snapshot("DRL-RUST-BROWSER-SAVE/4:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:0:"),
      Err(SnapshotError::UnsupportedVersion("4".to_string()))
    );
    assert_eq!(
      session.restore_snapshot("DRL-RUST-BROWSER-SAVE/3:other:142:1:2:drl-rs-ruleset-v1:1:w"),
  ...
  fn snapshot_rejects_each_incompatible_identity_before_restore() {
    let cases = [
      ...
      (
        "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:0:2:drl-rs-ruleset-v1:0:",
      ...
      (
        "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:1:drl-rs-ruleset-v1:0:",
      ...
      (
        "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:legacy-ruleset:0:",
  ...
  fn snapshot_rejects_noncanonical_v3_numbers_and_count_mismatches() {
    let mut session = BrowserSession::new().expect("fixed session");
    for token in [
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:0142:1:2:drl-rs-ruleset-v1:0:",
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:+142:1:2:drl-rs-ruleset-v1:0:",
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:01:w",
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:2:w",
      "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:1:é",
    ] {
      assert_eq!(
  ...
  fn late_replay_failure_keeps_the_active_session_unchanged() {
    ...
    session
      ...
      .expect("legal command");
    let before = session.clone();
    let token = "DRL-RUST-BROWSER-SAVE/3:fixed-m4-v1:142:1:2:drl-rs-ruleset-v1:2:mr;x";
...
mod wasm_tests {
  ...
  fn v3_storage_round_trip_and_rejection_quarantine_are_bounded() {
    ...
    let rejected_token = token.replace(":142:", ":127:");
    storage
