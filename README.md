...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.6`),
...
- Browser and presentation slice:
  ...
  - Pure contracts cover effect timing, low-health tone/pulse, explosion marks,
    ...
    burst directions/range sampling, decal-cell mapping, and post-process
    glow/LUT math without claiming full backend fidelity.
- Staged work:
