...
- **Rich Tactical Arsenal**: Typed weapon behavior covers six chainfire families (BFG 10K, Chaingun, Minigun, Plasma Rifle, Laser Rifle, and Nuclear Plasma Rifle) with one deterministic initial/warming/sustained/saturated whole-rule model, full-burst atomic ammunition checks, and fixed-target continuation. It also covers deterministic BFG fanout, the Rocket Launcher’s typed direct Fire hit and bounded radius-4 Fire splash with thresholded lowest-ID ground-item destruction, the Anti-Freak Jackal’s typed radius-1 Fire splash, Null Pointer’s typed radius-1 Plasma splash, Blue Armor’s typed 20% Plasma mitigation on BFG and Null Pointer fanouts, Red Armor’s typed 25% Fire mitigation on Rocket direct/splash and Anti-Freak fanouts, BFG 9000 actor fanout, shotgun reloads, kinetic pellet knockback, plasma energy volleys, and exotic unique artifacts (Trigun, Subtle Knife, Grammaton).
