...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.136`),
...
- Staged work:
  ...
  - M9 now includes definition-backed rocket and power-cell ammo families,
    ...
    contact damage, Acid/Lava/Water's typed 1250-unit movement policy, and
    optional Acid/Fire damage-type projection, are
    behavior-covered through typed
    deterministic transitions and events in the headless core;
    resistance, running modifiers, Mud movement,
