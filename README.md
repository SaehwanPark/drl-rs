...
- **Rich Tactical Arsenal**: Typed weapon behavior covers six chainfire families (BFG 10K, Chaingun, Minigun, Plasma Rifle, Laser Rifle, and Nuclear Plasma Rifle) with one deterministic initial/warming/sustained/saturated whole-rule model, full-burst atomic ammunition checks, and fixed-target continuation. It also covers deterministic BFG fanout, the BFG 10K’s typed direct Plasma volley, the Standard and Nuclear BFG 9000s’ typed direct Plasma hits and radius-8 Plasma fanouts, the Blaster/Laser Rifle/Plasma Rifle/Nuclear Plasma Rifle/Plasma Shotgun/Tristar Blaster’s typed direct Plasma hits, the Rocket Launcher’s typed direct Fire hit and bounded radius-4 Fire splash with thresholded lowest-ID ground-item destruction, the Missile Launcher’s typed direct Fire hits, 4-rocket magazine, single-rocket tactical reload, and bounded radius-3 Fire splash with typed 6d6 fanout, falloff, knockback, source self-damage, and thresholded lowest-ID ground-item destruction, the Revenant’s Launcher’s typed direct Fire hits with exact-hit one-rocket magazine, single-rocket tactical reload, and bounded radius-3 Fire splash with thresholded lowest-ID ground-item destruction, the Anti-Freak Jackal’s typed direct Fire hit and radius-1 Fire splash, the Mega Buster’s three-projectile 9mm volley, post-kill typed Bullet/Fire/Acid/Plasma morph from explicit target equipment, exact profile dice (1d8, 4d2, 4d2, 1d10), and bounded Fire/Acid radius-one fanout, Null Pointer’s typed radius-1 SPLASMA-style Plasma splash with one-third armor protection, Blue Armor’s typed 20% Plasma mitigation on Blaster/Laser Rifle/Plasma Rifle/Nuclear Plasma Rifle/Plasma Shotgun/Tristar Blaster/BFG direct/fanout and Null Pointer fanouts, Red Armor’s typed 25% Fire mitigation on Rocket direct/splash, Anti-Freak direct/splash, Missile Launcher direct/splash, and Revenant’s Launcher direct/splash, shotgun reloads, kinetic pellet knockback, plasma energy volleys, and exotic unique artifacts (Trigun, Subtle Knife, Grammaton).
