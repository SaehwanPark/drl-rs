...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.81`),
...
- Staged work:
  ...
  - M9 now includes definition-backed rocket and power-cell ammo families,
    ...
    plasma-rifle, rocket-launcher, Revenant's Launcher, Railgun, and Acid
    Spitter families with replay/atlas coverage;
    resistance, movement,
