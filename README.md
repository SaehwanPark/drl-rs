...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.185`),
...
- Staged work:
  ...
  - M9 now includes definition-backed rocket and power-cell ammo families,
    ...
    the Nuclear BFG 9000 now shares that exact-hit policy while retaining its
    own recharge and overload behavior; shot-cost, projectile routing,
