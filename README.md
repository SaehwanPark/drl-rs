...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.66`),
...
- Staged work:
  ...
  - M9 now includes definition-backed rocket and power-cell ammo spawn families
    ...
    replay JSON names, atlas slots, and a typed rocket-box ammo-pack boundary;
    prepared-slot consumption and broader legacy weapon/item behavior remain
    staged.
