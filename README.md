...
- **Rich Tactical Arsenal**: Modeled weapon behaviors including first-level BFG 10K, Chaingun, Minigun, Plasma Rifle, Laser Rifle, and Nuclear Plasma chainfire, deterministic BFG 10K radius-2 actor fanout, single-shell shotgun reloads, kinetic pellet knockback, plasma energy volleys, BFG 9000/10K area explosions, and exotic unique artifacts (Trigun, Subtle Knife, Grammaton).
