...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.22`),
...
- Staged work:
  ...
  - Build-time legacy-content conversion extracts shallow scalar fields with
    ...
    beings, item families, terrain cells, and special-level metadata; it never
    ships a Lua runtime or silently infers behavior.
