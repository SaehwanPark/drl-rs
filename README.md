...
- **Rich Tactical Arsenal**: Modeled weapon behaviors including first-level Chaingun and Minigun chainfire, single-shell shotgun reloads, kinetic pellet knockback, plasma energy volleys, BFG 9000/10K area explosions, and exotic unique artifacts (Trigun, Subtle Knife, Grammaton).
