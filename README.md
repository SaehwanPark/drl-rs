...
- Versioned delivery:
  - `VERSION` is the canonical `x.y.z` project value (currently `0.2.72`),
...
- Staged work:
  ...
  - M9 now includes definition-backed rocket and power-cell ammo families,
    ...
    descriptions, and a typed plasma-rifle family with replay/atlas coverage;
    resistance, movement, prepared-slot consumption, dynamic healing, weapon
    callbacks, and broader legacy item behavior remain staged.
