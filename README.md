...
- **Replay-File Verification CLI**: The native `drl-rs replay verify [path|-]` command reads the canonical V2 replay envelope from a UTF-8 file or stdin and performs a deterministic double-run check with stable diagnostics.
