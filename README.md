...
- **Rich Tactical Arsenal**: Typed weapon behavior covers six chainfire families (BFG 10K, Chaingun, Minigun, Plasma Rifle, Laser Rifle, and Nuclear Plasma Rifle) with one deterministic initial/warming/sustained/saturated whole-rule model, full-burst atomic ammunition checks, and fixed-target continuation. It also covers deterministic BFG fanout, the BFG 10K’s typed direct Plasma volley, the Standard and Nuclear BFG 9000s’ typed direct Plasma hits and radius-8 Plasma fanouts, the Blaster/Laser Rifle/Plasma Rifle/Nuclear Plasma Rifle/Plasma Shotgun/Tristar Blaster’s typed direct Plasma hits, the Rocket Launcher’s typed direct Fire hit and bounded radius-4 Fire splash with thresholded lowest-ID ground-item destruction, the Anti-Freak Jackal’s typed direct Fire hit and radius-1 Fire splash, Null Pointer’s typed radius-1 SPLASMA-style Plasma splash with one-third armor protection, Blue Armor’s typed 20% Plasma mitigation on Blaster/Laser Rifle/Plasma Rifle/Nuclear Plasma Rifle/Plasma Shotgun/Tristar Blaster/BFG direct/fanout and Null Pointer fanouts, Red Armor’s typed 25% Fire mitigation on Rocket direct/splash and Anti-Freak direct/splash, shotgun reloads, kinetic pellet knockback, plasma energy volleys, and exotic unique artifacts (Trigun, Subtle Knife, Grammaton).
