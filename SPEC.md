...
## 2. Active Implementation Slice: M9 — BFG 10K Tenth-Level Chainfire

### 2.1 Objective

Extend the delivered typed BFG 10K first-, second-, third-, fourth-, fifth-,
sixth-, seventh-, eighth-, and ninth-level chainfire commands with the
legacy-pinned tenth warm-up level. After accepted four-, five-, and
seven-projectile bursts leave the weapon at warm-up level nine, a valid
tenth-level command must emit
...
- **Observable outcome:** A tenth-level BFG 10K chainfire command is admitted
  only for a living visible target, a loaded clip of at least thirty-five cells,
  and a weapon warm-up level of nine. It consumes thirty-five cells, emits
  ...
  slots, and advances warm-up to level ten. Ordinary fire still resets the
  warm-up state, and the eleventh level remains rejected atomically.
- **Gameplay/replay impact:** Gameplay semantics advance from `102` to `103`;
  replay wire/schema, RNG sampling, generator, and ruleset identities remain
  unchanged. Project version advances from `0.2.293` to `0.2.294`.
...
- **Evidence boundary:** Pinned BFG 10K chainfire, shot-cost, and exact-hit
  ...
  remain `NOT_RUN`.
- **Non-goals:** Eleventh and later chainfire levels, legacy target rotation or
...
fourth-, fifth-, sixth-, seventh-, eighth-, and ninth-level transitions already
exist.
